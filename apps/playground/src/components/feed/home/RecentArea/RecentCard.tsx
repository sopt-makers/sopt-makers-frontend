...
const RecentCard = ({ recentPosts, onClick }: RecentCardProps) => {
  const { id, title, content, createdAt, likeCount, commentCount, categoryTagLabel, totalVoteCount } = recentPosts;
